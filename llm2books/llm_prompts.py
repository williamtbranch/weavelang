...
def load_prompt_template(filename: str) -> Optional[str]:
    ...
    try:
        ...
        print(f"ERROR: Could not read prompt template file {file_path}: {e}", file=sys.stderr)
        return None
...
if __name__ == '__main__':
    ...
    else: print("Skipping Call 1 formatter test due to missing template.")
    ...
    else: print("Skipping Call 3 formatter test due to missing template.")
    ...
    else: print("Skipping Call 4 formatter test due to missing template.")
    ...
    else: print("Skipping Call 5 formatter test due to missing template.")
    
    print("\n--- Testing Call 6 Formatter ---")
    sentences6_data = [{"id": "bk1_s1","eng_text": "The quick brown fox.","sims_l3_segments": [{"id": "S1", "text": "El rápido zorro"},{"id": "S2", "text": "marrón."}],"phrase_alignments_l3_to_eng": [{"id": "S1", "sims_l3_segment_text": "El rápido zorro", "eng_span_text": "The quick brown"},{"id": "S2", "sims_l3_segment_text": "marrón.", "eng_span_text": "fox."}],"l3_simsl_per_segment": {"S1": "el rápido zorro","S2": "marrón"}}]
    ...
    else: print("Skipping Call 6 formatter test due to missing template.")